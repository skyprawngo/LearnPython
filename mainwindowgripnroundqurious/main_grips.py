...
class MyApp(QMainWindow):
    ...
    def init_UI(self):
        ...
        self.left_grip = PyGrips(self.widget_1, "left")
        self.right_grip = PyGrips(self.widget_1, "right")
        self.top_grip = PyGrips(self.widget_1, "top")
        self.bottom_grip = PyGrips(self.widget_1, "bottom")
        self.top_left_grip = PyGrips(self.widget_1, "top_left")
        self.top_right_grip = PyGrips(self.widget_1, "top_right")
        self.bottom_left_grip = PyGrips(self.widget_1, "bottom_left")
        self.bottom_right_grip = PyGrips(self.widget_1, "bottom_right")
